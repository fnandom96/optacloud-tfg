...
import com.optacloud.domain.CloudletDifficultyComparatorClass;
 ...
 */
@PlanningEntity(difficultyComparatorClass = CloudletDifficultyComparatorClass.class)
public class Cloudlet {
    ...
    //The vm that is planned to execute de cloudlet.
    private Vm vm;
    ...
    //Historial de ids de les VM on ha estat el cloudlet
    private List<Integer> vm_history = null;

    //Indica si el cloudlet s'esta migrant
    private boolean migrating = false;

    //Intervals de temps de quan s'executa un cludlet a cada vm
    private List<Double> timeIntervals = new ArrayList<>();

    //Número de cops que ha sigut assignat a una VM
    ...
    //Retorna l'historial de VM's on s'ha executat el cloudlet
    public List<Integer> getVmHistory() {
        return vm_history;
    }

    //Afegir a l'historial la VM on s'executa el cloudlet
    public void addVmToHistory(int vmid) {
        vm_history.add(vmid);
    }

    //Retorna si el cloudlet està en proces de migració
    public boolean getMigrating() {
        return migrating;
    }

    //Marca el cloudlet com en estat de migració
    public void setMigrating(boolean migrating) {
        this.migrating = migrating;
    }

    //Retorna intervals de temps en el que s'executa un Cloudlet a cada VM
    public List<Double> getTimeIntervals() {
        return timeIntervals;
    }

    public void addTimeIntervals(double t) {
        timeIntervals.add(t);
    }

    //Retorna el número de cops que el cloudlet ha estat assignat
    public int getAssignations() {
        return assignations;
    }

    //Incrementa el nombre de vegades que s'ha assignat un cloudlet a una VM
    public void incAssignations() {
        ++this.assignations;
    }

    //Estableix quantes vegades s'ha assignat un Cloudlet a una VM
