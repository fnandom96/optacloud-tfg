...
public class CloudSim {
	...
	private static double minTimeBetweenEvents = 0.1;
        ...
        //Si s'està utilitzant el motor OptaPlanner, adquireix el valor de true
	 ...
	 * @post $none
	 */
	public static void init(int numUser, Calendar cal, boolean traceFlag, boolean useOpta) {
		try {
			initCommonVariable(cal, traceFlag, numUser);

                        //determina si s'utilitza el motor optaplanner o cloudsim
                        opta = useOpta;
			// create a GIS object
	...
	public static void init(int numUser, Calendar cal, boolean traceFlag, double periodBetweenEvents) {
	    ...
	    init(numUser, cal, traceFlag, false);
