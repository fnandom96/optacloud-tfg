...
public class CloudSimTags {
	...
	//L'usuari demana moure una VM
	public static final int MIGRATE_VM_ACK = BASE + 49;

	//L'usuari desallotja una VM
	public static final int DEALLOCATE_VM_ACK = BASE + 50;

	//S'incorporen noves VM i Cloudlets al sistema
	public static final int DELAYED_RESOURCES = BASE + 51;

	//Aturar els cloudlets executant-se a una VM
	public static final int PAUSE_VMCLOUDLETS = BASE + 52;
